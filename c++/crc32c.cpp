class CRC32C {
    ...
    public:
        ...
        static const int T8_0_START = 0 * 256;
        static const int T8_1_START = 1 * 256;
        static const int T8_2_START = 2 * 256;
        static const int T8_3_START = 3 * 256;
        static const int T8_4_START = 4 * 256;
        static const int T8_5_START = 5 * 256;
        static const int T8_6_START = 6 * 256;
        static const int T8_7_START = 7 * 256;
        ...
        void update(char* b, int off, int len){
            ...
            while(len > 7){
                ...
                int c1 = (b[off + 1] ^ (localCrc >>= 8)) & 0xff;
                int c2 = (b[off + 2] ^ (localCrc >>= 8)) & 0xff;
                int c3 = (b[off + 3] ^ (localCrc >>= 8)) & 0xff;
